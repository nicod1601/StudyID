...
function readSettings() {
  if (!fs.existsSync(SETTINGS_FILE)) {
    const initial = { localModelUrl: DEFAULT_MODEL_URL, localModelId: 'fast', iaEngine: 'auto', minimizeToTray: true, iaNotifications: true, hplanningUrl: '', edtReminders: [], edtRemindersEnabled: true, edtReminderMinutesBefore: 15, editorTabSize: 4, editorIndentWithTabs: false, editorShowWhitespace: false, showIaBubble: true, showNotesBubble: true, showChatBubble: true };
  ...
  try {
    ...
    if (s.showIaBubble === undefined) s.showIaBubble = true;
    if (s.showNotesBubble === undefined) s.showNotesBubble = true;
    if (s.showChatBubble === undefined) s.showChatBubble = true;
    return s;
  } catch (e) {
    return { localModelUrl: DEFAULT_MODEL_URL, localModelId: 'fast', iaEngine: 'auto', minimizeToTray: true, iaNotifications: true, hplanningUrl: '', edtReminders: [], edtRemindersEnabled: true, edtReminderMinutesBefore: 15, editorTabSize: 4, editorIndentWithTabs: false, editorShowWhitespace: false, showIaBubble: true, showNotesBubble: true, showChatBubble: true };
  }
}
